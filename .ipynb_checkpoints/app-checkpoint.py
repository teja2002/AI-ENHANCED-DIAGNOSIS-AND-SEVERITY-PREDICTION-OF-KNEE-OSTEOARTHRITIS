...
st.set_page_config(page_title="AI-ENHANCED-DIAGNOSIS-AND-SEVERITY-PREDICTION-OF-KNEE-OSTEOARTHRITIS")

class_names = ["Healthy", "Doubtful", "Minimal", "Moderate", "Severe"]
model = tf.keras.models.load_model("model_inception_ft.hdf5")
target_size = (224, 224)
